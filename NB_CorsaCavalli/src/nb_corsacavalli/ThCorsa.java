...
public class ThCorsa extends Thread {
     ...
     * @author Galimberti_Francesco
     *
     * Dichiarazione dell'attributo che memorizza se si vuole utilizzare lo
     * sleep
     */
     ...
     * @author Galimberti_Francesco
     *
     * Dichiarazione dell'attributo che memorizza se si vuole utilizzare lo yeld
     */
     ...
     * @param usaSleep il parametro serve per passare al metodo un valore
     * booleano per permettere l'utilizzo o meno dello sleep
     * @param usaYield il parametro serve per passare al metodo un valore
     * booleano per permettere l'utilizzo o meno dello yeld
     ...
     * termina. Il Thread quindi provvederà a salvare il numero dei galoppi. Ad
     * ogni galoppo effettuato verrà salvata una stringa in un vettore
